...
async function runLegacyRendererDispatchTests() {
  ...
  assertIncludes(amicareMarkup, '<div class="site-frame-root"><nav', "Amicare default nav is a direct site-frame-root child")
  assertIncludes(amicareMarkup, '</main><footer', "Amicare default footer is a direct site-frame-root child")
  assertExcludes(amicareMarkup, 'data-cms-editable-chrome', "Amicare default renderer has no CMS chrome wrapper")
  assertExcludes(amicareMarkup, 'cms-block--site-chrome', "Amicare default renderer has no CMS site chrome block")
  ...
  assertIncludes(amicareMarkup, '<p class="font-serif text-[14px] italic text-ink">Roermond e.o.</p>', "Amicare location card keeps its small serif paragraph")
  assertIncludes(amicareMarkup, '<p class="text-ink-muted">Limburg-Noord</p>', "Amicare location card keeps its muted supporting paragraph")
