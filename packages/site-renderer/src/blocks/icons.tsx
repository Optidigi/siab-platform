import {
  ...
  HeartHandshake, Link as LinkIcon, List, Lock, Mail, Map, MapPin, Maximize, Menu,
  ...
  Shield, ShoppingBag, ShoppingCart, Sliders, Smartphone, Sparkles, Star, Sun, Tag,
...
const ICON_MAP: Record<string, LucideIcon> = {
  ...
  ear: Ear, edit: Edit, "external-link": ExternalLink, eye: Eye, file: File,
  "file-text": FileText, filter: Filter, flag: Flag, folder: Folder, gift: Gift,
  globe: Globe, grid: Grid, hash: Hash, heart: Heart, "heart-handshake": HeartHandshake, home: Home, image: Image,
  ...
  "shopping-cart": ShoppingCart, sliders: Sliders, smartphone: Smartphone, sparkles: Sparkles,
