...
describe("customer preview UI", () => {
  ...
  it("renders checkout as a branded two-step flow with domain fee states", () => {
    ...
    expect(checkout).toContain("h-13 pr-12 text-base font-medium md:h-14 md:text-lg")
    expect(checkout).toContain('CardTitle className="text-2xl md:text-3xl"')
    ...
    expect(checkout).toContain('active && "bg-primary text-primary-foreground"')
    expect(checkout).toContain('complete && "bg-success text-success-foreground"')
