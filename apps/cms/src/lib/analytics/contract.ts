...
export const ANALYTICS_EVENT_CONTRACT: AnalyticsEventContractEntry[] = [
  {
    ...
    canonicalUse: "PostHog-native web analytics page views. Public sites require cookie consent; authenticated CMS tracking is first-party product analytics.",
    duplicatePrevention: "Public sites initialize PostHog only after consent; the CMS initializes PostHog in the admin shell; SIAB does not manually emit $pageview.",
  ...
  },
  {
    ...
    consentRequired: true,
    cmsConsentRequired: false,
    canonicalUse: "PostHog-native page leave/session-duration and native scroll-depth signal. Public sites require cookie consent; authenticated CMS tracking is first-party product analytics.",
    duplicatePrevention: "Public sites initialize PostHog only after consent; the CMS initializes PostHog in the admin shell; SIAB does not manually emit $pageleave and keeps SDK scroll properties enabled.",
  ...
  },
  {
    ...
    consentRequired: true,
    cmsConsentRequired: false,
    canonicalUse: "Native PostHog Web Vitals for field performance scoring.",
